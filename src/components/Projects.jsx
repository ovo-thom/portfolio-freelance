          ...
          <div className="project-description text-xl lg:w-1/2 px-5">
            <div className="py-3 mb-4 rounded-lg">
              ...
              <p className="mb-4 text-gray-100 text-base">
                ...
                temps réel les derniers films à l&apos;affiche, les tendances du
                moment, et les résultats de recherche personnalisés.
              </p>
              <Link
                to="/projects/3"
            ...
            <div className="py-3 mb-4 rounded-lg">
              ...
              <p className="mb-4 text-gray-100 text-base">
                ...
                chez BeCode. Il s’agit d’un site e-commerce dédié aux artisans,
                développé avec React et Vite pour le front-end. Le site intègre
                des fonctionnalités essentielles telles que la gestion du
                panier, les filtres de produits et une navigation fluide.
              </p>
              <a
