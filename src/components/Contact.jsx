...
const Contact = () => {
  return (
    <div id="contact">
      <section className="contact-section bg-gradient-to-br from-gray-950 via-slate-950 to-black text-gray-400">
        <div className="flex flex-col lg:flex-row pt-8 px-8 space-y-6 lg:space-y-0 lg:space-x-8 lg:items-stretch">
          <div className="contact-left lg:w-1/2">
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-all duration-300 h-full flex flex-col justify-between">
              ...
              <p className="text-gray-300 lg:text-lg leading-relaxed mb-6">
                ...
                d&apos;interfaces modernes avec Nextjs, React et Tailwind CSS,
                je suis motivé et prêt à relever de nouveaux défis.
              </p>
        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 mx-8 mt-8 mb-0 hover:bg-white/10 transition-all duration-300">
