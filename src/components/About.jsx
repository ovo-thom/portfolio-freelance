          ...
          <div className="md:w-full w-full p-4">
            <div className="text-base w-[90%] mx-auto md:text-lg lg:text-xl leading-relaxed mb-8">
              ...
              <p className="text-gray-300 text-base">
                ...
                CSS, je suis actuellement à la recherche d’un poste où je
                pourrai mettre à profit mes compétences tout en continuant à
              ...
              <p className="text-gray-300 text-base">
                Diplômé de BeCode, j’ai développé une expertise en front-end
                grâce à une pédagogie active favorisant l’autonomie et la
                collaboration. J’ai maîtrisé des technologies comme HTML, CSS,
                JavaScript, et React, et réalisé un projet de site e-commerce
